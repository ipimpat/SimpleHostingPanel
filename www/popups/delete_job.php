...
<div id="container">
  ...
  <div id="middle">
    ...
    <form name="submit" action="popup.php?page=delete_job" method="post">
    <? echo "<input name=\"id\" type=\"hidden\" value=\"".$id."\" />" ?>
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
        <tr>
          <td colspan="3"><strong>That you wanna delete job ID: <? echo $id; ?></strong></td>
        </tr>
        <tr>
...
<?
	if(isset($_POST['id'])){
		...
		mysql_query("DELETE FROM jobqueue WHERE id = '$id'") or die(mysql_error());
